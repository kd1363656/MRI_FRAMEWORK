...
void FWK::Window::Init()
{
	...
	m_windowConfig.styleTag = Tag::WindowStyleNormalTag::GetTypeInfo().k_id;
}
...
void FWK::Window::ApplyWindowConfig(const CommonStruct::WindowConfig& a_windowConfig)
{
	...
	// ウィンドウスタイルを変更
	SetWindowLongPtr(m_hWND, GWL_STYLE, l_style);
...
void FWK::Window::SetClientSize()
{
	...
	if (m_windowConfig.styleTag == Tag::WindowStyleFullScreenTag::GetTypeInfo().k_id)
	{
