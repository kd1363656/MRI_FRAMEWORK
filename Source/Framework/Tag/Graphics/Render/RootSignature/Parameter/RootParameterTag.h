...
namespace FWK::Tag
{
	...
	struct RootParameterModelMeshletBoundsBufferTag	final : public RootParameterTagBase { FWK_DEFINE_TYPE_INFO_TAG(RootParameterModelMeshletBoundsBufferTag, RootParameterTagBase) };
