...
{
	class RenderGraphTestSceneColorReadPass final : public RenderGraphPassBase
	{
	public:

		 RenderGraphTestSceneColorReadPass();
		~RenderGraphTestSceneColorReadPass() override;
		...
		FWK_DEFINE_TYPE_INFO(RenderGraphTestSceneColorReadPass, RenderGraphPassBase);
	};
}