...
{
	class RenderGraphTestSceneColorWritePass final : public RenderGraphPassBase
	{
	public:

		 RenderGraphTestSceneColorWritePass();
		~RenderGraphTestSceneColorWritePass() override;
		...
		FWK_DEFINE_TYPE_INFO(RenderGraphTestSceneColorWritePass, RenderGraphPassBase);
	};
}