...
bool FWK::Graphics::FBXLoaderContext::LoadStaticModelFile(const std::filesystem::path& a_filePath) const
{
	if (!m_fbxManager)
	{
	...
	return m_staticModelFBXLoader.LoadStaticModelFile(a_filePath, l_staticModelData, m_fbxManager);
}
